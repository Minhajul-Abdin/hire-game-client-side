...
// Assuming you are using better-auth or a similar library based on your signup client
...
export default function SigninPage() {
  ...
  return (
    <div className="flex py-30 min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
